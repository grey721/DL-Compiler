...
class NpuConv2d(ConvBase):
    ...
    def block_shape_reverse_inference(self, block_address_list):

        # sl 列表长度
        bh, bw, bc, sl = block_address_list.shape  # np的shape
        assert sl == 6  # 可能代表每个块有6个地址信息
    ...
    def update_block_address_list(self, npu_op_block_address_list, block_address_list):
        ...
        block_address_list, block_pad_list = self.block_shape_reverse_inference(block_address_list)
    ...
    def tile_shape_reverse_inference(self, tile_address_list, block_address_list):
    ...
    def update_tile_address_list(self, npu_op_flow_tile_address_list, tile_address_list, block_address_list):
        ...
        tile_address_list, tile_pad_list = self.tile_shape_reverse_inference(tile_address_list, block_address_list)
...
class NpuActivation(RELU):
    ...
    def update_block_address_list(self, npu_op_block_address_list, block_address_list):
        npu_op_block_address_list['output_block_address_list'] = deepcopy(block_address_list)
        block_address_list = self.shape_reverse_inference(block_address_list)
        npu_op_block_address_list['input_block_address_list'] = deepcopy(block_address_list)
    ...
    def update_tile_address_list(self, npu_op_flow_tile_address_list, tile_address_list):
        npu_op_flow_tile_address_list['input_tile_address_list'] = deepcopy(tile_address_list)
        tile_address_list = self.shape_reverse_inference(tile_address_list)
        npu_op_flow_tile_address_list['output_tile_address_list'] = deepcopy(tile_address_list)
...
class NpuResize(Resize):
    ...
    def block_shape_reverse_inference(self, block_address_list):
        ...
        block_address_list[0][0][0][1] = self.InputH
        block_address_list[0][0][0][3] = self.InputW
    ...
    def update_block_address_list(self, npu_op_block_address_list, block_address_list):
        ...
        npu_op_block_address_list['output_block_address_list'] = deepcopy(block_address_list)
        block_address_list = self.block_shape_reverse_inference(block_address_list)
        npu_op_block_address_list['input_block_address_list'] = deepcopy(block_address_list)

        return block_address_list

    def tile_shape_reverse_inference(self, tile_address_list):
    ...
    def update_tile_address_list(self, npu_op_flow_tile_address_list, tile_address_list):
        ...
        tile_address_list, tile_drop_line_list = self.tile_shape_reverse_inference(tile_address_list)
...
class NpuConcat(Concat):
    ...
    def update_block_address_list(self, npu_op_block_address_list, block_address_list):
        ...
        npu_op_block_address_list['output_block_address_list'] = deepcopy(block_address_list)
        block_address_list_0, block_address_list = self.block_shape_reverse_inference(block_address_list)
...
class NpuPad(Pad):
    ...
    def update_tile_address_list(self, npu_op_flow_tile_address_list, tile_address_list):
        ...
        npu_op_flow_tile_address_list['output_tile_address_list'] = deepcopy(tile_address_list)
        npu_op_flow_tile_address_list['input_tile_address_list'] = deepcopy(tile_address_list)
        tile_address_list, tile_pad_list = self.tile_shape_reverse_inference(tile_address_list)
        npu_op_flow_tile_address_list['tile_pad_list'] = deepcopy(tile_pad_list)
        return tile_address_list
...
class block_param(object):
    ...
    def tile_split(self):
        ...
        if isinstance(self.NpuOp.NpuOpFlow[-1], NpuResize) \
            ...
            # assert (scale) % 1 == 0 ,'resize scaling factor must be a integer'
